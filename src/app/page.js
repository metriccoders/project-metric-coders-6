      ...
      <div className="grid grid-cols-1 justify-center text-center mt-4 mb-6">
        <div>
          <span className="font-extrabold">
            Welcome to Metric Coders Personal Diary Summarizer!
          </span>
        </div>
        <div>
          <span className="italic">
            Feel free to summarize your activities!
          </span>
        </div>
      </div>
        ...
        <div className="m-2">
          {outputResponse == "" && (
            <span className="justify-center text-center">
              Write in detail here to get your summary!
            </span>
          )}
        ...
        <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 m-2">
          <div className="m-1">
            <TextField
              ...
              placeholder="Complete details here!"
              variant="outlined"
              multiline
              fullWidth
              value={inputText}
